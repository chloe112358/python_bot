...
# Define your error handler function
...
def start(update: Update, context: CallbackContext) :
    ...
    # Send a message with the topics keyboard
...
def generate_question(update: Update, context: CallbackContext): 
    #if 'message' in update and 'text' in update['message'] and update['message']['text']:
        # Get the current topic and clear the user_data
        ...
        # Save the current question in the user_data
        ...
        # Add the handler to the updater
